...
namespace View {
    ...
    ViewSector2D::ViewSector2D() {
        _program.load(
            GL::Shader("assets/shaders/sector2D.vs", GL::Shader::Type::VertexShader),
            GL::Shader("assets/shaders/sector2D.fs", GL::Shader::Type::FragmentShader)
        );
    }
    ...
    void ViewSector2D::render(const Model::Sector& sector) {
    ...
    void ViewSector2D::setVertexData(const Model::Sector& sector) {
